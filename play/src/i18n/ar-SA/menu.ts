...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "تقليل الضوضاء من TechPulse",
            workAdventureNoiseSuppressionDescription: "معالجة صوت الميكروفون باستخدام تقليل الضوضاء في TechPulse.",
            recommended: "موصى به",
        ...
        privacySettings: {
            ...
            explanation: 'إذا لم يكن تبويب TechPulse نشطًا، سيتم التبديل إلى "وضع الغياب".', // If the TechPulse tab is not active, it will switch to "absence mode".
