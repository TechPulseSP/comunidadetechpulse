...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "المتصفح الخاص بك ({browserName}) لم يعد مدعوماً من TechPulse.",
        description: "متصفحك قديم جداً لتشغيل TechPulse. يرجى تحديثه إلى أحدث إصدار للمتابعة.",
        whatToDo: "ماذا يمكنك أن تفعل؟",
        option1: "تحديث {browserName} إلى أحدث إصدار",
        option2: "مغادرة TechPulse واستخدام متصفح مختلف",
        updateBrowser: "تحديث المتصفح",
        leave: "مغادرة",
    },
    pwaInstall: {
        title: "تثبيت TechPulse",
        description: "ثبّت التطبيق للحصول على تجربة أفضل: وصول سريع، وتشغيل عند بدء التشغيل، وتجربة شبيهة بالتطبيقات.",
        descriptionIos: "أضف TechPulse إلى الشاشة الرئيسية للحصول على تجربة أفضل ووصول سريع.",
        feature1Title: "وصول سريع",
        feature1Description: "شغّل TechPulse من قائمة ابدأ أو الـ Dock أو سطح المكتب.",
        feature2Title: "نافذة تطبيق مستقلة",
        feature2Description: "أبقِ TechPulse منفصلًا عن علامات تبويب المتصفح واعثر عليه بسرعة في شريط المهام.",
        feature3Title: "ابدأ مع تشغيل الجهاز",
        feature3Description: "شغّل TechPulse عند بدء تشغيل جهازك.",
