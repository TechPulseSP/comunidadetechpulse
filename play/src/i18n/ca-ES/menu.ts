...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Supressió de soroll de TechPulse",
            workAdventureNoiseSuppressionDescription:
                "Processa el micròfon amb la supressió de soroll de TechPulse.",
        ...
        privacySettings: {
            ...
            explanation:
                'Quan la pestanya de TechPulse al seu navegador no és visible, TechPulse cambia al "mode no present"',
    ...
    contact: {
        gettingStarted: {
            title: "Començar",
            description:
                "TechPulse us permet crear un espai en línia per comunicar-vos espontàneament amb altres. I tot comença creant el vostre propi espai. Escolliu entre una gran selecció de mapes prefabricats pel nostre equip.",
        },
        createMap: {
