...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "TechPulse-Geräuschunterdrückung",
            workAdventureNoiseSuppressionDescription:
                "Verarbeite dein Mikrofon mit der Geräuschunterdrückung von TechPulse.",
            recommended: "Empfohlen",
        ...
        privacySettings: {
            ...
            explanation: "Falls der TechPulse-Tab nicht aktiv ist, wird in den „Abwesenheitsmodus“ umgeschaltet.",
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Mit TechPulse kannst du eine Onlinewelt erschaffen, in der du dich spontan mit anderen treffen und unterhalten kannst. Erstelle als erstes deine eigene Karte. Es steht dir eine große Auswahl an vorgefertigten Karten von unserem Team zur Verfügung.",
        },
        createMap: {
