...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Ihr Browser ({browserName}) wird von TechPulse nicht mehr unterstützt.",
        description:
            "Ihr Browser ist zu alt, um TechPulse auszuführen. Bitte aktualisieren Sie ihn auf die neueste Version, um fortzufahren.",
        whatToDo: "Was können Sie tun?",
        option1: "{browserName} auf die neueste Version aktualisieren",
        option2: "TechPulse verlassen und einen anderen Browser verwenden",
        updateBrowser: "Browser aktualisieren",
        leave: "Verlassen",
    },
    pwaInstall: {
        title: "TechPulse installieren",
        description:
            "Installieren Sie die App für ein besseres Erlebnis: schneller Zugriff, automatischer Start und ein app-ähnliches Erlebnis.",
        descriptionIos:
            "Fügen Sie TechPulse für ein besseres Erlebnis und schnellen Zugriff zu Ihrem Home-Bildschirm hinzu.",
        feature1Title: "Schneller Zugriff",
        feature1Description: "Starten Sie TechPulse über Ihr Startmenü, Dock oder Ihren Desktop.",
        feature2Title: "Eigenes App-Fenster",
        feature2Description:
            "Halten Sie TechPulse getrennt von Ihren Browser-Tabs und finden Sie TechPulse auf einen Blick in Ihrer Taskleiste.",
        feature3Title: "Mit dem Computer starten",
        feature3Description: "Starten Sie TechPulse, wenn Ihr Gerät hochfährt.",
        ...
        install: "TechPulse-App installieren",
