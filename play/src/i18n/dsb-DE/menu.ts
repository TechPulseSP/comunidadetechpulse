...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Wótpóranje šuma TechPulse",
            workAdventureNoiseSuppressionDescription: "Pśeźěłajśo swój mikrofon z wótpóranim šuma TechPulse.",
        ...
        privacySettings: {
            ...
            explanation: 'Jolic až TechPulse-tab njejo aktiwny, ga aktiwěrujo se "modus njepśibytnosći".',
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Z pomocu TechPulse móžoš stwóriś online-swět, źož móžoš se z drugimi spontanje zmakaś a rozgranjaś. Napóraj nejpjerwjej swóju kórtu. Tebje stoj k dispoziciji wjelika licba južo pśigótowanych kórtow wót našogo teama.",
        },
        createMap: {
