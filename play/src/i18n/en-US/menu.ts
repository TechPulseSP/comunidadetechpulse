...
const menu: BaseTranslation = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "TechPulse noise suppression",
            workAdventureNoiseSuppressionDescription: "Process your microphone with TechPulse's noise suppression.",
            recommended: "Recommended",
        ...
        privacySettings: {
            title: "Away mode",
            explanation:
                'While the TechPulse tab in your browser is not visible. TechPulse switches to "away mode"',
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "TechPulse allows you to create an online space to communicate spontaneously with others. And it all starts with creating your own space. Choose from a large selection of prefabricated maps by our team.",
        },
        createMap: {
