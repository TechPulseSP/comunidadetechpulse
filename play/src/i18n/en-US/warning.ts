...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Your browser ({browserName}) is no longer supported by TechPulse.",
        description: "Your browser is too old to run TechPulse. Please update to the latest version to continue.",
        whatToDo: "What can you do?",
        option1: "Update {browserName} to the latest version",
        option2: "Leave TechPulse and use a different browser",
        updateBrowser: "Update Browser",
        leave: "Leave",
    },
    pwaInstall: {
        title: "Install TechPulse",
        description:
            "Install the app for a better experience: quick access, load on startup and an app-like experience.",
        descriptionIos: "Add TechPulse to your Home Screen for a better experience and quick access.",
        feature1Title: "Quick access",
        feature1Description: "Launch TechPulse from your Start menu, Dock, or desktop.",
        feature2Title: "Dedicated app window",
        feature2Description:
            "Keep TechPulse separate from your browser tabs and find TechPulse at a glance in your taskbar.",
        feature3Title: "Start with your computer",
        feature3Description: "Launch TechPulse when your device starts.",
