...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Supresión de ruido de TechPulse",
            workAdventureNoiseSuppressionDescription:
                "Procesa tu micrófono con la supresión de ruido de TechPulse.",
        ...
        privacySettings: {
            ...
            explanation:
                'Cuando la pestaña de TechPulse en su navegador no es visible, TechPulse cambia a "modo no presente"',
    ...
    contact: {
        gettingStarted: {
            title: "Empezar",
            description:
                "TechPulse le permite crear un espacio en línea para comunicarse espontáneamente con otros. Y todo empieza creando su propio espacio. Escoja de una gran selección de mapas prefabricados por nuestro equipo.",
        },
        createMap: {
            title: "Crear su mapa",
