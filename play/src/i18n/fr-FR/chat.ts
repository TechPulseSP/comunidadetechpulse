...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    matrixSettings: {
        ...
        accountDataSection: "TechPulse (dans le jeu)",
        ...
        publishWokaToMatrixProfileConfirmWarning:
            "Cette action remplace le nom d’affichage et l’avatar de votre profil Matrix sur le serveur. Un nom ou une photo définis ailleurs (par ex. dans Element) seront écrasés. Ne continuez que si vous acceptez que votre nom TechPulse et votre WOKA deviennent votre profil Matrix public.",
