...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Potłóčowanje šuma TechPulse",
            workAdventureNoiseSuppressionDescription: "Předźěłajće swój mikrofon z potłóčowanjom šuma TechPulse.",
