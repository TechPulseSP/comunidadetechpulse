...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Waš wobhladowak ({browserName}) so wjace njepodpěruje wot TechPulse.",
        description:
            "Waš wobhladowak je přestarši, zo by TechPulse wuwjedł. Prošu aktualizujće jón na najnowšu wersiju, zo byšće pokročowali.",
        whatToDo: "Što móžeće činić?",
        option1: "{browserName} na najnowšu wersiju aktualizować",
        option2: "TechPulse wopušćić a druhi wobhladowak wužiwać",
        updateBrowser: "Wobhladowak aktualizować",
        leave: "Wopušćić",
    },
    pwaInstall: {
        title: "TechPulse instalować",
        description:
            "Instalujće app za lěpše dožiwjenje: spěšny přistup, start při startowanju a dožiwjenje kaž w app.",
        descriptionIos: "Přidajće TechPulse na swój startowy wobraz za lěpše dožiwjenje a spěšny přistup.",
        feature1Title: "Spěšny přistup",
        feature1Description: "Startujće TechPulse ze startoweho menija, Docka abo z desktopa.",
        feature2Title: "Swójske wokno app",
        feature2Description:
            "Dźeržće TechPulse wot browserowych rajtarkow dźělene a namakajće jo spěšnje w swojej nadawkowej lajsće.",
        feature3Title: "Z wašim kompjutorom startować",
        feature3Description: "Startujće TechPulse, hdyž so waš grat startuje.",
        ...
        install: "TechPulse-app instalować",
