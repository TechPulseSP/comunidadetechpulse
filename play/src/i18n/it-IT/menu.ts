...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Soppressione del rumore TechPulse",
            workAdventureNoiseSuppressionDescription:
                "Elabora il microfono con la soppressione del rumore di TechPulse.",
        ...
        privacySettings: {
            ...
            explanation:
                'Quando la scheda TechPulse nel tuo browser non è visibile, TechPulse passa alla modalità "assente"',
    ...
    contact: {
        gettingStarted: {
            title: "Iniziare",
            description:
                "TechPulse ti permette di creare uno spazio online per comunicare spontaneamente con gli altri. E tutto inizia con la creazione del tuo spazio. Scegli tra una vasta selezione di mappe prefabbricate dal nostro team.",
        },
        createMap: {
