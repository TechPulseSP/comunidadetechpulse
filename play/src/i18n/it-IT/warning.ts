...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Il tuo browser ({browserName}) non è più supportato da TechPulse.",
        description:
            "Il tuo browser è troppo vecchio per eseguire TechPulse. Si prega di aggiornarlo all'ultima versione per continuare.",
        whatToDo: "Cosa puoi fare?",
        option1: "Aggiornare {browserName} all'ultima versione",
        option2: "Uscire da TechPulse e utilizzare un browser diverso",
        updateBrowser: "Aggiorna browser",
        leave: "Esci",
    },
    pwaInstall: {
        title: "Installa TechPulse",
        description:
            "Installa l'app per un'esperienza migliore: accesso rapido, avvio automatico e un'esperienza simile a quella di un'app.",
        descriptionIos: "Aggiungi TechPulse alla schermata Home per un'esperienza migliore e un accesso rapido.",
        feature1Title: "Accesso rapido",
        feature1Description: "Avvia TechPulse dal menu Start, dal Dock o dal desktop.",
        feature2Title: "Finestra dell'app dedicata",
        feature2Description:
            "Tieni TechPulse separato dalle schede del browser e ritrovalo a colpo d'occhio nella barra delle applicazioni.",
        feature3Title: "Avvia con il computer",
        feature3Description: "Avvia TechPulse quando il dispositivo si accende.",
        ...
        install: "Installa l'app TechPulse",
