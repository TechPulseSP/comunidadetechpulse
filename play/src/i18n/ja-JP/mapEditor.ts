...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            ...
            label: "リンクを開く",
            description: "TechPulse 内または新しいタブとしてウェブサイトを開きます。",
            linkLabel: "リンク URL",
        ...
        youtube: {
            ...
            description: "TechPulse 内で YouTube ビデオを開くか、新しいタブとして開きます。",
        ...
        googleDocs: {
            ...
            description: "TechPulse 内で Google ドキュメントを開くか、新しいタブとして開きます。",
        ...
        klaxoon: {
            label: "Klaxoon を開く",
            description: "TechPulse 内で Klaxoon を開くか、新しいタブとして開きます。",
        ...
        googleSheets: {
            label: "Google シートを開く",
            description: "TechPulse 内で Google シートを開くか、新しいタブとして開きます。",
        ...
        googleSlides: {
            ...
            description: "TechPulse 内で Google スライドを開くか、新しいタブとして開きます。",
        ...
        googleDrive: {
            ...
            description: "TechPulse 内で Google ドライブを開くか、新しいタブとして開きます。",
        ...
        openFile: {
            label: "ファイルを開く",
            description: "TechPulse 内でファイルを開く。",
