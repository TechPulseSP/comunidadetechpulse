...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "TechPulse ノイズ抑制",
            workAdventureNoiseSuppressionDescription: "TechPulse のノイズ抑制でマイク音声を処理します。",
            recommended: "推奨",
        ...
        privacySettings: {
            title: "離席モード",
            explanation:
                "ブラウザの TechPulse タブが表示されていない間、TechPulse は離席モードに切り替わります。",
    ...
    contact: {
        gettingStarted: {
            title: "入門",
            description:
                "TechPulse を使用すると、他のユーザと自然にコミュニケーションできるオンラインスペースを作成することができます",
        },
        createMap: {
            title: "マップを作成します",
