...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "TechPulse-ruisonderdrukking",
            workAdventureNoiseSuppressionDescription:
                "Verwerk je microfoon met de ruisonderdrukking van TechPulse.",
            recommended: "Aanbevolen",
        ...
        privacySettings: {
            ...
            explanation:
                'Wanneer het TechPulse-tabblad in je browser niet zichtbaar is, schakelt TechPulse over naar de "afwezigheidsmodus"',
    ...
    contact: {
        gettingStarted: {
            title: "Aan de slag",
            description:
                "TechPulse stelt je in staat om een online ruimte te creëren om spontaan met anderen te communiceren. En het begint allemaal met het creëren van je eigen ruimte. Kies uit een grote selectie van prefab-kaarten door ons team.",
        },
        createMap: {
            title: "Maak je kaart",
