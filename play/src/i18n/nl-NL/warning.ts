...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Uw browser ({browserName}) wordt niet meer ondersteund door TechPulse.",
        description:
            "Uw browser is te oud om TechPulse uit te voeren. Werk deze bij naar de nieuwste versie om door te gaan.",
        whatToDo: "Wat kunt u doen?",
        option1: "{browserName} bijwerken naar de nieuwste versie",
        option2: "TechPulse verlaten en een andere browser gebruiken",
        updateBrowser: "Browser bijwerken",
        leave: "Verlaten",
    },
    pwaInstall: {
        title: "TechPulse installeren",
        description:
            "Installeer de app voor een betere ervaring: snelle toegang, starten bij het opstarten en een app-achtige ervaring.",
        descriptionIos: "Voeg TechPulse toe aan je beginscherm voor een betere ervaring en snelle toegang.",
        feature1Title: "Snelle toegang",
        feature1Description: "Start TechPulse vanuit je startmenu, Dock of vanaf je bureaublad.",
        feature2Title: "Eigen appvenster",
        feature2Description:
            "Houd TechPulse gescheiden van je browsertabbladen en vind TechPulse in een oogopslag terug op je taakbalk.",
        feature3Title: "Start met je computer",
        feature3Description: "Start TechPulse wanneer je apparaat opstart.",
        ...
        install: "TechPulse-app installeren",
