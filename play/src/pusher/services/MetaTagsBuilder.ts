...
export const MetaTagsDefaultValue: RequiredMetaTagsData = {
    title: "Comunidade TechPulse",
    description:
        "Espaco virtual da TechPulse para encontros, colaboracao e conversas espontaneas entre a equipe.",
    author: "TechPulse",
    provider: "TechPulse",
    favIcons: [
        {
    ...
    appName: "Comunidade TechPulse",
    shortAppName: "TechPulse",
    themeColor: "#3E8BF7",
